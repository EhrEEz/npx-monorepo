...
>
	<div class="fl-col jc-center al-center py-lg-9 h-full w-md-90 w-lg-80 w-xl-80 w-2xl-60 mx-auto">
		<h1 class="fl-col jc-center al-center">
			...
			<div class="hero__title heading-1 text-center mb-3" id="home-title">
...
<section
	class="ascii__section full-width content-grid"
	data-section="dark"
	aria-hidden="true"
	aria-label="Nepaxis ASCII Logo Section"
>
	<ASCII />
</section>
