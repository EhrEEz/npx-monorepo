...
export const load: PageServerLoad = ({ params }) => {
	const data = {
		...
		title: 'This is a sample text exactly sixty-five characters long, perfect for headlines!',
		category: 'Tutorial',
